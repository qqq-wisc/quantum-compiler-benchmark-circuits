...
def random_circuit(num_qubits, depth, max_operands=3, measure=False,
                   conditional=False, reset=False, seed=None, cxRZOnly=False, density=1):
        ...
        for depth in range(1,100,4):
            for density in densities:
                 random_circuit(num_qubits, depth, max_operands=2, measure=False,
                        conditional=False, reset=False, seed=None, cxRZOnly=True, density=density).qasm(filename=f"random_q{num_qubits:02}_d{depth:02}_r{density:02}.qasm")